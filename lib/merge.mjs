...
function mergeFinalNewline(baseValue, currentValue, nextValue) {
  if (currentValue === baseValue) return nextValue;
  if (nextValue === baseValue) return currentValue;
...
export function threeWayMerge(baseText, currentText, nextText) {
  ...
  const finalNewline = mergeFinalNewline(
    baseSplit.hasFinalNewline,
    currentSplit.hasFinalNewline,
