...
export async function runDoctor(targetDir) {
  ...
  checks.push(
    await readableNonEmpty(workflow)
      ...
      : check(
        ...
        'ci',
        'CI validation',
        'Framework validation workflow is not installed.',
  ...
  checks.push(
    await readableNonEmpty(validator)
      ...
      : check(
        ...
        'validator',
        'Local validation',
        'Local framework validation script is missing.',
  ...
  checks.push(
    await readableNonEmpty(promptPlanner) && await readableNonEmpty(promptReviewer)
      ? check('pass', 'agent-loop', 'Plan/review loop', 'Planning and independent-review prompts are available.')
      : check(
        'warn',
        'agent-loop',
        'Plan/review loop',
        'Planning or review prompt is missing.',
        'Restore the planning and code-review prompts or document an equivalent workflow.'
      )
  );
