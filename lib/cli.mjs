...
Options:
  ...
  --dir <directory>  Task/context: repository directory (default: current directory)
...
Examples:
  ...
  npx vibe-coding-production context accept-invite --mode review --include src/invitations/service.ts
`;
